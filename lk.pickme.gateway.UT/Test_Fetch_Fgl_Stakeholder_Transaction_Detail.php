...
echo '<br><br>FGL Test Case : Fetch stakeholder balance summary<br>';
// Build report request object
$reportRequest = new FglStakeholderTransactionDetailReportRequest();
...
$reportResponse = $client->report()->fetchFglStakeholderTransactionDetail($reportRequest);
echo '<br><br>Stakeholder detail transactions: ' . sizeof($reportResponse->getTransactions()) . '<br>';
foreach($reportResponse->getTransactions() as $transaction) {
	echo '<br>' . $transaction;
}