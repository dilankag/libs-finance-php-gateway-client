 ...
 */
class DriverTripSummaryJsonHelper extends BaseJsonHelper {
    
    public function fromJson($gatewayResponse) {
        // Map report response fields
        $responseData = $gatewayResponse["responseData"];
        $driverTripSummaryReportResponse = new DriverTripSummaryReportResponse();
        $summaries = parent::makeDriverTripSummaries($responseData["summaries"]);
        $driverTripSummaryReportResponse->setSummaries($summaries);
        return $driverTripSummaryReportResponse;
    }
